...
(function ($) {
    ...
    $('.js-show-modal18').on('click',function(e){
        e.preventDefault();
        $('.js-modal18').addClass('show-modal18');
    });

    $('.js-hide-modal18').on('click',function(){
        $('.js-modal18').removeClass('show-modal18');
    });
    ...
    $('.js-show-modal19').on('click',function(e){
        e.preventDefault();
        $('.js-modal19').addClass('show-modal19');
    });

    $('.js-hide-modal19').on('click',function(){
        $('.js-modal19').removeClass('show-modal19');
    });
    ...
    $('.js-show-modal20').on('click',function(e){
        e.preventDefault();
        $('.js-modal20').addClass('show-modal20');
    });

    $('.js-hide-modal20').on('click',function(){
        $('.js-modal20').removeClass('show-modal20');
    });
